...
export const DashboardView = ({ setActiveTab }) => {
  ...
  const courses = [
    {
      id: 1,
      title: "dfIntroduction to Reacgt",
      students: 125,
      progress: 75,
    ...
    <Tabs defaultValue="overview" value={mainTab} onValueChange={setMainTab}>
      ...
      <TabsContent value="overview">
        ...
        >
          ...
          <CoursesTable courses={courses} setActiveTab={setActiveTab} />
        </motion.div>
      </TabsContent>
    </Tabs>
  );
...
const CoursesTable = ({ courses, setActiveTab }) => (
...
const CoursesTableContent = ({ courses }) => (
